...
const footerLinks = {
  ...
  services: [
    { name: 'Ücretsiz Kargo', href: '/shipping' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              <h3 className="text-2xl font-bold text-primary-400">🍎 Elmalı Market</h3>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Taze, kaliteli ve organik ürünlerle ailenizin sağlıklı beslenme ihtiyaçlarını karşılıyoruz. 
              7/24 hizmet, hızlı teslimat ve güvenilir alışveriş deneyimi.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-sm text-gray-400">
              © 2024 Elmalı Market. Tüm hakları saklıdır.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-400">Güvenlik:</span>
              <div className="flex items-center space-x-2">
